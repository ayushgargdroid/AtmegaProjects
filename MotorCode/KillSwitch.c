...
void main(void)
{
	...
	while(1)
	{
		...
		{//Perfect X Axis
		    ...
		    {//180deg
		      leftf = 0;leftr = map(x,0,511,255,0);
		    ...
		    if(y<512-buffer2)
		    {
		      ...
		      else if(x<512-buffer2)
		      {
		        ...
		        if(x>refx)
		        {
		          ...
		          leftr = 0;
		          leftf = map(x,refx,511,0,255);
		        }
		        else
		        {
		          refx = refy = x;
		          rightf = 0;
		          rightr = map(x,0,511,255,0);
		          leftf = 0;
		          leftr = map(y,refy,511,0,255);
		        }
		      }
		    }
		    else
